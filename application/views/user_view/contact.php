  ...
  <body>
    ...
    <header class="header">
      <nav class="navbar navbar-expand-lg fixed-top">
        <div class="container"><a href="./" class="navbar-brand"><img src="assets/user/img/logo.svg" alt="" class="img-fluid"></a>
      ...
      <div class="container">
        ...
        <div class="row align-items-center mt-5">
          ...
          <div class="col-lg-5 contact-details mt-5 mt-lg-0">
            <div class="box">
              <div class="icon d-flex align-items-end"><img src="assets/user/img/placeholder.svg" alt="" class="img-fluid"></div>
              <h5>Address</h5>
              <p class="text-small font-weight-light">13/25 New Avenue, New Heaven, 45Y 73J, England, Great Britain</p>
            </div>
            <div class="box">
              <div class="icon d-flex align-items-end"><img src="assets/user/img/technology.svg" alt="" class="img-fluid"></div>
              <h5>Call center</h5>
            ...
            <div class="box">
              <div class="icon d-flex align-items-end"><img src="assets/user/img/multimedia.svg" alt="" class="img-fluid"></div>
    ...
    <script src="assets/user/vendor/lightbox2/js/lightbox.js"></script>
