          ...
          <div class="col-sm-6">
            <div class="breadcrumbs-area p-4 clearfix">
              <ul class="breadcrumbs pull-left">
                <li><a href="admin_tindakan">Daftar Harga</a></li>
                <li><a href="admin_home">Kategori Tindakan</a></li>
              </ul>
            </div>
          </div>
        </div>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-body">
                ...
                <h4 class="header-title mb-0">Tambah Kategori Tindakan</h4><hr>
  
<form action="<?php echo base_url().'admin_tindakan/tambah_data'; ?>" method="post">
        ...
        <div class="form-group row">
          <div class="col-6">
            <h6>Harga</h6>
            <input name="harga"  maxlength="8" class="form-control" onkeypress="return hanyaAngka(event)" placeholder="Masukkan Nominal Harga" id=""
            required oninvalid="this.setCustomValidity('Data tidak boleh kosong')" oninput="setCustomValidity('')">
          </div>
        </div>
  ...
  <h4 class="header-title mb-0">Kategori Tindakan</h4><hr>

<form action="<?php echo base_url().'admin_tindakan/cari'; ?>">
  ...
  <table class="table">
    <thead class="thead-dark">
                        <tr>
                          <th scope="col" class="align-middle text-center">ID Tindakan</th>
                          <th scope="col" class="align-middle text-center">Nama Tindakan</th>
