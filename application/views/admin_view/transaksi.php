...
<?php $this->load->view('layout_admin/nav2');?>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-body text-right">
                <a href="#" class="btn btn-success text-justify m-2">+ Tambah Data Transaksi</a>
                <div class="d-sm-flex justify-content-between align-items-center">
                  <h4 class="header-title mb-0">Data Transaksi</h4>
                </div>
                    ...
                    <table class="table">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td class="text-center"><a href="#" class="btn btn-primary text-center">Detail</a>
                          </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          ...
                          <td class="text-center"><a href="#" class="btn btn-primary text-center">Detail</a></td>
                        </tr>
                      </tbody>
                      <tbody></tbody>
                    </table>
