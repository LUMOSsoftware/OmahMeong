...
<form action="<?php echo base_url().'admin_pasien_lama/tambah_data'; ?>" method="post">


          <div class="form-group row">
          <div class="col-6">
            <h6>No RM</h6>
            <input name="title" class="form-control" onkeypress="return hanyaAngka(event)" placeholder="Masukkan No RM" id=""
          ...
          <div class="form-group">
              <h6>Nama Pemilik</h6>
              <input name="nama_pemilik"  class="form-control" placeholder="Masukkan Nama Pemilik" id="">
          </div>
          
          <div class="form-group">
             <h6>Nama Hewan</h6>
             <input name="nama_hewan" class="form-control"  placeholder="Masukkan Nama Hewan" id="">
          </div>
...
<script>
  ...
  {
    $("#title").autocomplete({
      source : "<?php echo base_url('admin_pasien_lama/get_autocomplete') ?>",

      select: function(event, ui){
        $('[name="title"]').val(ui.item.label);
        $('[name="nama_pemilik"]').val(ui.item.nama_pemilik);
        $('[name="nama_hewan"]').val(ui.item.nama_hewan);
